...
const SAMPLE_PRODUCTS = [
  ...
  { id: '7',  nome: 'Tabaco Amsterdam 25g',      categoria: 'Tabaco',     descricao: 'Blend suave e aromático, ideal para quem curte um cigarro levinho. 25g.',               preco: 18.00,  imagem: 'images/produtos/amsterdam.png',            disponivel: true,  destaque: true  },
  ...
  { id: '10', nome: 'Seda Bem Bolado',           categoria: 'Seda',       descricao: 'Brown slim ultrafina da Bem Bolado. Top de linha.',                                     preco: 5.00,  precoCombo: 12.00, qtdCombo: 3, imagem: 'images/produtos/seda_bb_slim_brown.png',            disponivel: true,  destaque: true  },
  ...
  { id: '12', nome: 'Seda Guru Spirit Ultra Longa', categoria: 'Seda',    descricao: 'Ultra longa Guru Spirit, queima lenta e saborosa.',                                    preco: 5.00,  precoCombo: 12.00, qtdCombo: 3, imagem: 'images/produtos/seda_ultra_longa_guru_spirit.png',            disponivel: true,  destaque: false },
  { id: '13', nome: 'Sedinha Guru Spirit',       categoria: 'Seda',       descricao: 'Sedinha Guru Spirit slim ultrafina. Fácil de rolar.',                                  preco: 4.00,  precoCombo: 10.00, qtdCombo: 3, imagem: 'images/produtos/sedinha_guru_spirit.png',            disponivel: true,  destaque: false },
  { id: '14', nome: 'Filtro Aleda Extra Longo',  categoria: 'Filtro',     descricao: 'Filtro extra longo Aleda Slim 22mm. 150 unidades. Filtração superior.',                 preco: 8.00,   imagem: 'images/produtos/filtro_aleda.png',            disponivel: true,  destaque: false },
  ...
  { id: '17', nome: 'Piteira Sadhu Large',       categoria: 'Piteira',    descricao: 'Bambu natural Sadhu large, 35 tips. Leve, resistente e sustentável.',                   preco: 5.00,   imagem: 'images/produtos/piteira_large_sadhu.png', disponivel: true,  destaque: false },
  ...
  { id: '19', nome: 'Cuia Colorida',             categoria: 'Cuia',       descricao: 'Cuia colorida Tonabê. Cores variadas — consulte disponibilidade.',                      preco: 16.00,  imagem: 'images/produtos/cuia_redonda.png',            disponivel: true,  destaque: false },
  ...
  { id: '21', nome: 'Tesoura Passarinho',        categoria: 'Tesoura',    descricao: 'Tesoura passarinho. Rosa/dourado ou furta-cor. Corte preciso.',                         preco: 16.00,  imagem: 'images/produtos/tesoura_passarinho.png',            disponivel: true,  destaque: false },
  { id: '22', nome: 'Tesoura Dobrável Tonabê',   categoria: 'Tesoura',    descricao: 'Tesoura dobrável Tonabê. Cores variadas. Prática e compacta.',                          preco: 16.00,  imagem: 'images/produtos/tesoura_tonabe_dobravel.png',            disponivel: true,  destaque: false },
  { id: '23', nome: 'Slick Tonabê 5ml',          categoria: 'Slick',      descricao: 'Slick de silicone Tonabê, 5ml. Ideal para guardar sua brisa.',                         preco: 16.00,  imagem: 'images/produtos/slick_tonabe.png',            disponivel: true,  destaque: false },
  { id: '24', nome: 'Slick Lego 26ml',           categoria: 'Slick',      descricao: 'Slick com tampa no estilo Lego, 26ml. Divertido e funcional.',                          preco: 25.00,  imagem: 'images/produtos/slick_lego.png',            disponivel: true,  destaque: false },
  { id: '25', nome: 'Dichavador Sadhu Peq.',     categoria: 'Dichavador', descricao: 'Sadhu plástico pequeno flor. Leve e prático para o dia a dia.',                        preco: 20.00,  imagem: 'images/produtos/dichavador_sadhu.png', disponivel: true,  destaque: false },
  { id: '26', nome: 'Dichavador Lion Rolling',   categoria: 'Dichavador', descricao: 'Lion Rolling Circus. Design exclusivo, resistente e compacto.',                         preco: 40.00,  imagem: 'images/produtos/dichavador_lion_rolling_circus.png',            disponivel: true,  destaque: false },
  { id: '27', nome: 'Dichavador Metal 4 Partes', categoria: 'Dichavador', descricao: 'Metal compacto, 4 partes. Estampas variadas. Ótimo para levar na bolsa.',               preco: 30.00,  imagem: 'images/produtos/dichavador_metal_4_partes.png',            disponivel: true,  destaque: false },
  ...
  { id: '30', nome: 'Dichavador Colmeia Metal',  categoria: 'Dichavador', descricao: 'Alien Dawg — metal premium colmeia, 4 partes com coador. Edição especial.',             preco: 120.00, imagem: 'images/produtos/dichavador_colmeia_metal_grande.png',            disponivel: true,  destaque: false },
  ...
  { id: '34', nome: 'Pilão Folha Chaveiro',      categoria: 'Acessório',  descricao: 'Mini pilão chaveiro com detalhe de folha. Compacto e estiloso.',                       preco: 16.00,  imagem: 'images/produtos/pilao_folha_chaveiro.png',            disponivel: true,  destaque: false },
  { id: '35', nome: 'Tubeck',                    categoria: 'Acessório',  descricao: 'Tubeck porta-cigarro. Prático para levar sem amassar.',                                preco: 10.00,  imagem: 'images/produtos/tubeck.png',            disponivel: true,  destaque: false },
...
const CAT_EMOJI = {
  Tabaco: '🌿', Seda: '📄', Piteira: '🎋', Cuia: '🥃', Kit: '🎁',
  Filtro: '🚬', Slick: '🧴', Dichavador: '⚙️', Isqueiro: '🔥',
  Bandeja: '🎨', Tesoura: '✂️', Acessório: '🛠️',
};
...
function renderFeatured() {
  ...
  grid.innerHTML = destaques.map(p => {
    ...
    const imgTag = p.imagem ? `<img src="${escHtml(p.imagem)}" alt="${escHtml(p.nome)}" loading="lazy" onerror="this.style.display='none';this.nextElementSibling.style.display='flex'">` : '';
    ...
    <div class="product-card" data-id="${escHtml(p.id)}" onclick="openProductModal('${escHtml(p.id)}')">
      <div class="product-img-wrap">${imgTag}${placeholder}</div>
      <div class="product-body">
        ...
        <div class="product-footer">
          ...
          <button class="btn-add ${inCart ? 'added' : ''}"
                  ...
                  title="Adicionar à sacola" aria-label="Adicionar ${escHtml(p.nome)} à sacola">
            ${inCart ? '✓' : '+'}
          </button>
        </div>
      </div>
...
function renderProducts(products) {
  ...
  grid.innerHTML = products.map(p => {
    ...
    return `
    <div class="product-card" data-id="${escHtml(p.id)}" onclick="openProductModal('${escHtml(p.id)}')">
      <div class="product-img-wrap">${imgTag}${placeholder}${badge}</div>
      <div class="product-body">
        <p class="product-category">${escHtml(p.categoria)}</p>
        <h3 class="product-name">${escHtml(p.nome)}</h3>
...
function addToCart(id) {
  ...
  saveCart(); renderCart(); syncCartButtons(); openCart();
  showToast(`✓ ${product.nome} adicionado`);
}

function removeFromCart(id) {
  cart = cart.filter(i => i.id !== id);
  saveCart(); renderCart(); syncCartButtons();
}
...
function saveCart() { localStorage.setItem('brisaria_cart', JSON.stringify(cart)); }
...
function renderCart() {
  ...
  if (!cart.length) {
    ...
    itemsEl.innerHTML = `<div class="cart-empty"><p>Sua sacola está vazia 🛍️</p><button class="btn btn-outline-dark btn-sm" onclick="closeCart()">Ver catálogo</button></div>`;
    return;
  }
  ...
  itemsEl.innerHTML = cart.map(item => {
    ...
    const thumb = item.imagem ? `<img src="${escHtml(item.imagem)}" alt="${escHtml(item.nome)}" onerror="this.outerHTML='${emoji}'">` : emoji;
    return `
    <div class="cart-item">
...
function syncCartButtons() {
  document.querySelectorAll('.product-card[data-id]').forEach(card => {
    ...
    if (btn) { btn.textContent = inCart ? '✓' : '+'; btn.classList.toggle('added', inCart); }
  });
}
...
function checkoutWhatsApp() {
  ...
  const msg = ['🌿 *Olá! Gostaria de fazer um pedido na Brisaria:*', '', ...lines, '', `💰 *Total: R$ ${formatPrice(total)}*`, '', 'Pode confirmar disponibilidade e forma de entrega? 😊'].join('\n');
...
function setupLoyaltyForm() {
  ...
  form.addEventListener('submit', async (e) => {
    ...
    let valid = true;
    [{ el: document.getElementById('loyaltyName'), val: nome }, { el: document.getElementById('loyaltyPhone'), val: whatsapp }]
      .forEach(({ el, val }) => { if (!val) { el.classList.add('error'); valid = false; } else el.classList.remove('error'); });
    if (!valid) return;
    submitBtn.textContent = 'Cadastrando...';
    submitBtn.disabled    = true;
    try {
      if (CONFIG.scriptUrl) {
        await fetch(CONFIG.scriptUrl, { method: 'POST', body: JSON.stringify({ action: 'cadastro_clube', nome, whatsapp, email, nascimento: nasc }) });
      } else {
        const msg = ['🌿 *Cadastro — Clube da Brisa*', '', `Nome: ${nome}`, `WhatsApp: ${whatsapp}`, email ? `Email: ${email}` : null, nasc ? `Nascimento: ${formatDate(nasc)}` : null].filter(Boolean).join('\n');
        window.open(`https://wa.me/${CONFIG.whatsappNumber}?text=${encodeURIComponent(msg)}`, '_blank');
      }
...
function setupPontosConsulta() {
  ...
  if (!section) return;
  if (!CONFIG.scriptUrl) { section.style.display = 'none'; return; }
...
async function consultarPontos() {
  ...
  if (!wNum) { input.classList.add('error'); return; }
  ...
  try {
    ...
    if (data.erro) {
      ...
      const resgatesHtml = (data.resgates_disponiveis && data.resgates_disponiveis.length)
        ? `<ul class="resgates-list">${data.resgates_disponiveis.map(r => `<li><span class="benefit-icon">✦</span>${r.pontos} pts → <strong>${escHtml(r.descricao)}</strong></li>`).join('')}</ul>`
...
function setupEventListeners() {
  ...
  document.getElementById('searchInput').addEventListener('input', e => { searchQuery = e.target.value.trim(); applyFilters(); });
...
function renderAccountPanel() {
  ...
  renderResgates(clienteLogado.resgates_disponiveis || [], clienteLogado.wpp);
  renderHistorico(clienteLogado.historico || []);
}

function renderResgates(resgates, wpp) {
  const el = document.getElementById('perfilResgates');
  if (!el) return;
  if (!resgates.length) {
    el.innerHTML = '<p class="resgates-empty">Continue comprando para ganhar resgates 🌿</p>';
    return;
  }
  el.innerHTML = `
    <p class="resgates-title">Disponível para resgatar:</p>
    <ul class="resgates-list">${resgates.map(r =>
      `<li>
        <span class="benefit-icon">✦</span>
        <span>${r.pontos} pts → <strong>${escHtml(r.descricao)}</strong></span>
        <button class="btn-resgatar" onclick="resgatarBrinde(${r.pontos},'${escHtml(r.descricao)}','${escHtml(wpp)}')">Resgatar</button>
      </li>`
    ).join('')}</ul>`;
}

async function resgatarBrinde(pontos, descricao, wpp) {
  if (!confirm(`Resgatar "${descricao}" por ${pontos} pontos?`)) return;
  try {
    const res  = await fetch(CONFIG.scriptUrl, {
      method: 'POST',
      body: JSON.stringify({ action: 'resgate', wpp, pontos }),
    });
    const data = await res.json();
    if (!data.ok) throw new Error(data.erro || 'Erro');
    clienteLogado.saldo             = (clienteLogado.saldo || 0) - pontos;
...
async function fazerLogin() {
  ...
  if (!wNum) { input.classList.add('error'); return; }
  input.classList.remove('error');
  if (!CONFIG.scriptUrl) { erroEl.textContent = 'Sistema de contas ainda não configurado.'; erroEl.classList.remove('hidden'); return; }
  ...
  try {
    ...
    const data = await res.json();
    if (data.erro) { erroEl.textContent = data.erro; erroEl.classList.remove('hidden'); }
    else {
...
function openProductModal(id) {
  ...
  if (!p) return;
  _modalProductId = id;
  _carouselImgs = Array.isArray(p.imagens) && p.imagens.length ? p.imagens : p.imagem ? [p.imagem] : [];
  _carouselIdx  = 0;
  ...
  if (p.precoCombo) { comboEl.textContent = `${p.qtdCombo} por R$ ${formatPrice(p.precoCombo)}`; comboEl.classList.remove('hidden'); }
  ...
  track.innerHTML = _carouselImgs.map(src => `<img src="${escHtml(src)}" alt="${escHtml(p.nome)}" loading="lazy">`).join('');
  track.style.transform = 'translateX(0)';
  const dots = document.getElementById('carouselDots');
  dots.innerHTML = _carouselImgs.length > 1
    ? _carouselImgs.map((_, i) => `<button class="carousel-dot${i === 0 ? ' active' : ''}" onclick="carouselGoTo(${i})"></button>`).join('')
    : '';
...
function carouselNav(dir) { _carouselIdx = Math.max(0, Math.min(_carouselImgs.length - 1, _carouselIdx + dir)); _applyCarousel(); }
function carouselGoTo(i)  { _carouselIdx = i; _applyCarousel(); }
...
function formatPrice(value) { return Number(value).toFixed(2).replace('.', ','); }
